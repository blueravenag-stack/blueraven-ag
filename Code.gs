// BLUE RAVEN AG — Google Apps Script v1.3
// No changes from v1.2 — included for reference only
// Paste into script.google.com — deploy as Web App (Anyone, execute as Me)
